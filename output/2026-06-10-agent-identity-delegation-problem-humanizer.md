...
Security and identity teams already feel something is off here. The instinct is to file it under non-human identity and treat it like a service account problem they have solved before. That instinct is wrong, and the gap between that instinct and the reality is where the risk sits.
